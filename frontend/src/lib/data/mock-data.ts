...
export const products: Equipment[] = [
  ...
  },
  {
    ...
    category: "Sistema PA",
    status: "available",
    serialNumber: "MSL-4522",
  },
  {
    id: "prod-003",
    name: "Robe Robin Pointe",
    category: "Cabezal móvil",
    status: "reserved",
    serialNumber: "RBP-1134",
  },
  {
    id: "prod-004",
    name: "Robe Robin Pointe",
  ...
  },
  {
    ...
    category: "Cabezal móvil",
    status: "available",
    serialNumber: "MAC-7821",
  },
  {
    id: "prod-006",
    name: "DiGiCo SD12",
    category: "Mesa de mezclas",
    status: "reserved",
    serialNumber: "DGC-3301",
  },
  {
    id: "prod-007",
    name: "DiGiCo SD10",
    category: "Mesa de mezclas",
    status: "available",
    serialNumber: "DGC-2205",
  },
  {
    id: "prod-008",
    name: "Shure Axient Digital",
    category: "Micrófono inalámbrico",
    status: "available",
    serialNumber: "SHR-8844",
  },
  {
    id: "prod-009",
    name: "Shure Axient Digital",
    category: "Micrófono inalámbrico",
    status: "inactive",
    serialNumber: "SHR-8832",
  },
  {
    id: "prod-010",
    name: "MA Lighting grandMA3",
    category: "Consola de iluminación",
    status: "reserved",
    serialNumber: "MA3-1102",
  },
];
